...
/// Ergonomic alias for ISO_9899.
///
/// Allows natural C-style access:
/// ```swift
/// import ISO_9899
///
/// let len = C.String.length(of: ptr)
/// C.String.Memory.copy(to: dest, from: src, count: 16)
/// let sine = C.Math.sin(x)
/// ```
public typealias C = ISO_9899
